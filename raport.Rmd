...
Na podstawie powyższego wykresu można stwierdzić, że największy wpływ na długość śledzi ma temperatura wody oraz zagęszczenie widłogonów gat. 1. Atrybuty takie jak miesiąc oraz X, czyli numer porządkowy, zostały pominięte celowo, ponieważ nie mają znaczenia dla naszej analizy danych.
